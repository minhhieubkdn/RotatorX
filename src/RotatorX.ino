...
#define DEFAULT_JERK 500000	 // mm/s3
#define DEFAULT_ACCELERATION 5000 // mm/s2

#define DEFAULT_SPEED 100
#define MAX_SPEED 200 // mm/s
#define HOMING_SPEED 20
#define BEGIN_SPEED 2

#define MIN_POSITION -90
#define MAX_POSITION 90
#define DEFAULT_HOME_POSITION -70

#define DEFAULT_STEP_PER_MM 26.666666 // pul/rev = 1000, vitme = 1605; 1000 / 5 = 200 pul/mm
...
void initValues()
{
	...
	EEPROM.begin();
	EEPROM.get(0, home_position);
	delay(20);
	if (home_position == 0) {
		COMMAND_PORT.println("Home Position have'nt saved!");
...
void handle_serial_data()
{
	...
	if (inputString == "IsRotateX")
	{
		COMMAND_PORT.println("YesRotateX");
		inputString = "";
	...
	else if (messageBuffer == "M327")
	{
		home_position = inputString.substring(5).toFloat();
		EEPROM.put(0, home_position);
		COMMAND_PORT.println("Ok");
	}
	else if (messageBuffer == "M328") {
		home_position = EEPROM.get(0, home_position);
		COMMAND_PORT.println("Ok");
	}
